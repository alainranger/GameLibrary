...
namespace GameLibrary.Tests.WinAppDriver;
...
public class BasicTests
{
    ...
    private const string AppToLaunch = "C:\\Users\\alain\\source\\repos\\GameLibrary\\GameLibrary\\bin\\Debug\\net6.0-windows10.0.19041.0\\GameLibrary.exe";
    ...
    public void LaunchApp()
    {
        if (AppSession == null)
        {
            ...
            //    var mainWindow = AppSession.FindElementByAccessibilityId("GameLibraryMainWindow");
